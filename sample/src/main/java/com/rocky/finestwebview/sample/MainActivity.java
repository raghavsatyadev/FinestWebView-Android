package com.rocky.finestwebview.sample;
...
import com.rocky.finestwebview.FinestWebView;
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.defaultTheme) {
            new FinestWebView.Builder(this)
                    ...
                    .show("https://www.malaymail.com/news/money/2019/12/04/bursa-reprimands-g-neptune-four-former-directors/1816080");
